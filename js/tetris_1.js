...
Pieza.prototype.cargarImg = function(){
    ...
    switch(this.tipo){
        case 0:
            url = "img/piezastetris/barra" + this.inc + ".png";
            break;
        case 1:
            url = "img/piezastetris/cubo.png";
            break;
        case 2:
            url = "img/piezastetris/ld" + this.inc + ".png";
            break;
        case 3:
            url = "img/piezastetris/li" + this.inc + ".png";
            break;
        case 4:
            url = "img/piezastetris/sd" + this.inc + ".png";
            break;
        case 5:
            url = "img/piezastetris/si" + this.inc + ".png";
            break;
        case 6:
            url = "img/piezastetris/t" + this.inc + ".png";
            break;
...
function dibujarProxima(proxima){
    ...
    switch(proxima){
        case 0:
            url = "img/piezastetris/barra1.png";
            break;
        case 1:
            url = "img/piezastetris/cubo.png";
            break;
        case 2:
            url = "img/piezastetris/ld1.png";
            break;
        case 3:
            url = "img/piezastetris/li1.png";
            break;
        case 4:
            url = "img/piezastetris/sd1.png";
            break;
        case 5:
            url = "img/piezastetris/si1.png";
            break;
        case 6:
            url = "img/piezastetris/t1.png";
            break;
